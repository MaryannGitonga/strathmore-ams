    ...
    <div class="container">
		...
		<div class="jumbotron ">
            ...
            <div class="unit-section flex mt-3">
                ...
                class="self-end text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded all ">
                    Completed Units
                </a>
                <a href="{{route('Pending.index')}}"
                class="ml-2 self-end text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded all" >
                    Pending Units
            </a>
            <a href="{{route('Compulsory.index')}}"
                class="ml-2 self-end text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded all" >
        ...
        <table class="min-w-full">
          <thead>
            <tr>
                ...
                <th class="th theading">Comments</th>
            </tr>
