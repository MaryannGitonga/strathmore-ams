...
<body>
  ...
  <div class="registration p-2" style="width: 80%">
  <div class="unit-section flex mt-3">
    <a href="{{route('registration')}}" class="registered ml-4 mx-2 p-2" style="text-decoration: none; background-color: darkgrey;">Registered Units</a>
    <a href="{{route('available')}}" class="available mx-2 p-2" style="text-decoration: none;">Available Units</a>    
  </div>
            ...
            <table class="table mt-3">
              ...
              <tbody class="bg-white">
                <tr class="tr">
                  ...
                  <td class="td text-sm leading-5 text-gray-900"><a href="#">Register</a></td>
                </tr>
